...
Für alle Anforderungen wurden so Metriken definiert und in einer Tabelle festgehalten.

Diese Tabelle wird in \ref{GQM} dargestellt und enthält das Ergebnis der Anwendung von \ac{GQM} auf die Anforderungen mit allen definierten Metriken.  

\todo{Einbau der Tabelle überdenken....eher Anhang, aber wie dann hier?}
\begin{table}[!h]
	\centering
	\begin{tabular}{c}
		\includegraphics[width=0.9\linewidth]{Bilder/GQM.pdf}	
	\end{tabular}
