...
Für eine einfache Darstellung reicht die Unterscheidung zwischen Erfüllen (1) und Nichterfüllen (0) der Anforderungen. Das Ergebnis wird anschließend mit den Gewichten der Prioritäten multipliziert und aufsummiert. 

\todoInline{Weiter...}

\subsubsection{Resultat präsentieren}
\todoInline{Komplett überarbeiten}
