...
\newparagraph{\ac{MFEM} vorstellen}
\todoInline{Ablauf beschreiben}

\newparagraph{Architektur vorstellen}
\todoInline{Ablauf beschreiben}
...
Damit ein Service dies erfüllt und somit in der Architektur funktionieren kann, müssen anhand der Umstände, wie z.~B. Servicediscovery, Logging oder Tracing, Anforderungen definiert werden. Nur wenn das Framework eines Services diese unterstützt, kann garantiert werden, dass sich das Risiko zur Erfüllung des Qualitätszieles minimiert.
