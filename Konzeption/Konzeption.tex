...
Für die Basisanforderungen wurden die Kategorien Funktionalität, Performance, Benutzbarkeit, Sicherheit, Wartbarkeit und Zukunftssicherheit definiert. Anschließend wurden diesen die Qualitätsanforderungen zugeordnet und stellen ein Beispiel dar, wie ein entsprechender Quality Utility Tree aufgebaut ist. Bild \ref{MSQUTAusschnitt} zeigt einen Ausschnitt des gesamten Baumes, wobei der vollständige Baum im Anhang zu finden ist. 
...
Der in Bild \ref{MSQUTAusschnitt} gezeigte Quality Utility Tree wurde im Bild \ref{MSQUTPrio} um Prioritäten erweitert. Wobei dies nur ein Beispiel ist und bei jeder Bewertung separat durchgeführt werden sollte.

\image[MSQUTPrioAusschnitt.pdf][width=0.7\linewidth]{MSQUTPrio}{\acs{MFEM} Quality Utility Tree Beispiel mit Prioritäten}{Beispiel eines Quality Utility Tree der Basisanforderungen mit Prioritäten}
...
\begin{table}[!htb]
	...
	\begin{tabular}{p{3cm}|p{3cm}|p{2cm}|p{8cm}}
		...
		& sehr gut & Das Framework lässt sich schnell erlernen und ist intuitive zu bedienen. Es nimmt dem Nutzer, wo es geht, Arbeit ab. 
		\\ \cline{3-4} & 
		...
		& automatisch & Das Framework de- und serialisiert Objekte automatisch ins JSON Format.                                              
		\\ \cline{3-4} & 
