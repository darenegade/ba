...
\newglossaryentry{Qualitaet}{
	name=Qualität,
	description={Nach der DIN EN ISO 9000:2015-11 ist Qualität, der \enquote{Grad, in dem ein Satz inhärenter Merkmale eines Objekts Anforderungen erfüllt}. Sie gibt somit das Ausmaß an, wie ein Produkt den bestehenden Anforderungen nachkommt. Dabei sind \enquote{inhärente Merkmale} die Merkmale, die dem Produkt innewohnen. Sie grenzen sich damit von den zugeordneten Merkmalen ab, wie z.~B. dem Preis.}
}
